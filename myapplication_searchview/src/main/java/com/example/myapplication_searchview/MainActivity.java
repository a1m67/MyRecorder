...
public class MainActivity extends AppCompatActivity {
    ...
    private void initDatas() {
        ...
        Animals animal1 = new Animals("喜羊羊","喜气洋洋过大年",R.drawable.ic_launcher_background);
        Animals animal2 = new Animals("懒羊羊","我就是喜欢吃",R.drawable.ic_launcher_background);
        Animals animal3 = new Animals("灰太狼","我一定会回来的",R.drawable.ic_launcher_background);
        Animals animal4 = new Animals("小灰灰","喜羊羊哥哥，带我一起玩",R.drawable.ic_launcher_background);
        for (int i = 0; i < 10; i++) {
            datas.add(animal1);
            datas.add(animal2);
            datas.add(animal3);
